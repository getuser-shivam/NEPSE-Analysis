...
async function copyAssets() {
  const sourceDirs = [
    { src: path.join(ROOT_DIR, 'packages', 'client_sdk', 'web'), dest: path.join(SITE_DIR, 'dart-client') },
    { src: path.join(ROOT_DIR, 'apps', 'mobile', 'build', 'web'), dest: path.join(SITE_DIR, 'flutter-app') },
    { src: path.join(ROOT_DIR, 'apps', 'mobile', 'web'), dest: path.join(SITE_DIR, 'flutter-web-source') },
  ];
