          ...
          child: Column(
            children: [
              ListTile(
                ...
                trailing: StatusPill(label: 'Optimal', color: AppColors.positive),
              ),
            ],
          ),
        ),
      ...
      children: [
        Expanded(
          child: GlassContainer(
            child: Column(
              children: [
                const Text('Total Revenue', style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
    ...
    return GlassContainer(
      ...
      child: Column(
        children: interactions.map<Widget>((item) {
          return ListTile(
            title: Text('Product: ${item['productId'].toString().substring(0, 8)}...'),
