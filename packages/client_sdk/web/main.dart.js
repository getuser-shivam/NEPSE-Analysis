// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.11.2.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    AppSettings: function AppSettings(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11) {
      var _ = this;
      _.id = t0;
      _.name = t1;
      _.autoSaveInterval = t2;
      _.maxDataAgeDays = t3;
      _.backupEnabled = t4;
      _.chartStyle = t5;
      _.defaultPeriod = t6;
      _.maxWatchlistSize = t7;
      _.logLevel = t8;
      _.refreshInterval = t9;
      _.createdAt = t10;
      _.updatedAt = t11;
    },
    DashboardSnapshot_DashboardSnapshot$fromJson(json) {
      var rawSymbols, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16,
        t1 = type$.nullable_List_dynamic,
        rawWatchlist = t1._as(json.$index(0, "watchlist"));
      if (rawWatchlist == null)
        rawWatchlist = B.List_empty;
      rawSymbols = t1._as(json.$index(0, "symbols"));
      if (rawSymbols == null)
        rawSymbols = B.List_empty;
      t1 = A.DateTime_parse(A._asString(json.$index(0, "generatedAt")));
      t2 = type$.Map_dynamic_dynamic;
      t3 = type$.String;
      t4 = type$.dynamic;
      t5 = A.LinkedHashMap_LinkedHashMap$from(t2._as(json.$index(0, "settings")), t3, t4);
      t6 = A._asString(t5.$index(0, "id"));
      t7 = A._asString(t5.$index(0, "name"));
      t8 = B.JSNumber_methods.toInt$0(A._asNum(t5.$index(0, "autoSaveInterval")));
      t9 = B.JSNumber_methods.toInt$0(A._asNum(t5.$index(0, "maxDataAgeDays")));
      t10 = A._asBool(t5.$index(0, "backupEnabled"));
      t11 = A._asString(t5.$index(0, "chartStyle"));
      t12 = A._asString(t5.$index(0, "defaultPeriod"));
      t13 = B.JSNumber_methods.toInt$0(A._asNum(t5.$index(0, "maxWatchlistSize")));
      t14 = A._asString(t5.$index(0, "logLevel"));
      t15 = B.JSNumber_methods.toInt$0(A._asNum(t5.$index(0, "refreshInterval")));
      t16 = A.DateTime_parse(A._asString(t5.$index(0, "createdAt")));
      t5 = A.DateTime_parse(A._asString(t5.$index(0, "updatedAt")));
      t4 = A.PortfolioOverview_PortfolioOverview$fromJson(A.LinkedHashMap_LinkedHashMap$from(t2._as(json.$index(0, "portfolio")), t3, t4));
      t3 = J.map$1$1$ax(rawWatchlist, new A.DashboardSnapshot_DashboardSnapshot$fromJson_closure(), type$.WatchlistItem);
      t2 = A.List_List$_of(t3, t3.$ti._eval$1("ListIterable.E"));
      t2.$flags = 1;
      t3 = J.map$1$1$ax(rawSymbols, new A.DashboardSnapshot_DashboardSnapshot$fromJson_closure0(), type$.DashboardSymbolSnapshot);
      t3 = A.List_List$_of(t3, t3.$ti._eval$1("ListIterable.E"));
      t3.$flags = 1;
      return new A.DashboardSnapshot(t1, new A.AppSettings(t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t5), t4, t2, t3);
    },
    DashboardSnapshot: function DashboardSnapshot(t0, t1, t2, t3, t4) {
      var _ = this;
      _.generatedAt = t0;
      _.settings = t1;
      _.portfolio = t2;
    ...
    DashboardSnapshot_DashboardSnapshot$fromJson_closure: function DashboardSnapshot_DashboardSnapshot$fromJson_closure() {
    },
    DashboardSnapshot_DashboardSnapshot$fromJson_closure0: function DashboardSnapshot_DashboardSnapshot$fromJson_closure0() {
    },
    DashboardSnapshot_toJson_closure: function DashboardSnapshot_toJson_closure() {
    },
    DashboardSnapshot_toJson_closure0: function DashboardSnapshot_toJson_closure0() {
    },
    DashboardSymbolSnapshot_DashboardSymbolSnapshot$fromJson(json) {
      var t1, t2, t3, t4, t5,
        rawRecentPrices = type$.nullable_List_dynamic._as(json.$index(0, "recentPrices"));
      if (rawRecentPrices == null)
        rawRecentPrices = B.List_empty;
      t1 = A._asString(json.$index(0, "symbol"));
      t2 = A._asBoolQ(json.$index(0, "inPortfolio"));
      t3 = A._asBoolQ(json.$index(0, "inWatchlist"));
      t4 = json.$index(0, "holding") == null ? null : A.PortfolioHolding_PortfolioHolding$fromJson(A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(json.$index(0, "holding")), type$.String, type$.dynamic));
      t5 = J.map$1$1$ax(rawRecentPrices, new A.DashboardSymbolSnapshot_DashboardSymbolSnapshot$fromJson_closure(), type$.PriceSnapshot);
      t5 = A.List_List$_of(t5, t5.$ti._eval$1("ListIterable.E"));
      t5.$flags = 1;
      return new A.DashboardSymbolSnapshot(t1, t2 === true, t3 === true, t4, t5);
    },
    DashboardSymbolSnapshot: function DashboardSymbolSnapshot(t0, t1, t2, t3, t4) {
      var _ = this;
      _.symbol = t0;
      _.inPortfolio = t1;
      _.inWatchlist = t2;
    ...
    DashboardSymbolSnapshot_DashboardSymbolSnapshot$fromJson_closure: function DashboardSymbolSnapshot_DashboardSymbolSnapshot$fromJson_closure() {
    },
    DashboardSymbolSnapshot_toJson_closure: function DashboardSymbolSnapshot_toJson_closure() {
    },
    PortfolioHolding_PortfolioHolding$fromJson(json) {
      var t6, t7,
        _s11_ = "lastUpdated",
        t1 = A._asString(json.$index(0, "id")),
        t2 = A._asString(json.$index(0, "symbol")),
        t3 = A._asNum(json.$index(0, "shares")),
        t4 = A._asNum(json.$index(0, "buyPrice")),
        t5 = A._asNumQ(json.$index(0, "currentPrice"));
      if (t5 == null)
        t5 = null;
      t6 = A._asStringQ(json.$index(0, "notes"));
      t7 = json.$index(0, _s11_) == null ? null : A.DateTime_parse(A._asString(json.$index(0, _s11_)));
      return new A.PortfolioHolding(t1, t2, t3, t4, t5, t6, t7, A.DateTime_parse(A._asString(json.$index(0, "createdAt"))), A.DateTime_parse(A._asString(json.$index(0, "updatedAt"))));
    },
    PortfolioHolding: function PortfolioHolding(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
      var _ = this;
      _.id = t0;
      _.symbol = t1;
      _.shares = t2;
    ...
    PortfolioOverview_PortfolioOverview$fromJson(json) {
      var t1, t2,
        rawHoldings = type$.nullable_List_dynamic._as(json.$index(0, "holdings"));
      if (rawHoldings == null)
        rawHoldings = B.List_empty;
      t1 = J.map$1$1$ax(rawHoldings, new A.PortfolioOverview_PortfolioOverview$fromJson_closure(), type$.PortfolioHolding);
      t1 = A.List_List$_of(t1, t1.$ti._eval$1("ListIterable.E"));
      t1.$flags = 1;
      t2 = A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(json.$index(0, "summary")), type$.String, type$.dynamic);
      return new A.PortfolioOverview(t1, new A.PortfolioSummary(A._asNum(t2.$index(0, "totalInvestment")), A._asNum(t2.$index(0, "totalValue")), A._asNum(t2.$index(0, "totalGainLoss")), A._asNum(t2.$index(0, "totalReturnPct")), B.JSNumber_methods.toInt$0(A._asNum(t2.$index(0, "numStocks")))));
    },
    PortfolioOverview: function PortfolioOverview(t0, t1) {
      this.holdings = t0;
      this.summary = t1;
    },
    PortfolioOverview_PortfolioOverview$fromJson_closure: function PortfolioOverview_PortfolioOverview$fromJson_closure() {
    },
    PortfolioOverview_toJson_closure: function PortfolioOverview_toJson_closure() {
    },
    PortfolioSummary: function PortfolioSummary(t0, t1, t2, t3, t4) {
      var _ = this;
      _.totalInvestment = t0;
      _.totalValue = t1;
      _.totalGainLoss = t2;
      _.totalReturnPct = t3;
      _.numStocks = t4;
    },
    PriceSnapshot: function PriceSnapshot(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) {
      var _ = this;
      _.id = t0;
      _.symbol = t1;
      _.tradeDate = t2;
    ...
    WatchlistItem: function WatchlistItem(t0, t1, t2, t3, t4) {
      var _ = this;
      _.id = t0;
      _.symbol = t1;
      _.notes = t2;
    ...
    NepseApiException$(details, message, statusCode) {
      return new A.NepseApiException(statusCode, message, details);
    },
    NepseApiException: function NepseApiException(t0, t1, t2) {
      this.statusCode = t0;
      this.message = t1;
      this.details = t2;
    },
    NepseApiClient: function NepseApiClient(t0, t1) {
      this.baseUrl = t0;
      this._httpClient = t1;
    },
    NepseDashboardService: function NepseDashboardService(t0) {
      this._apiClient = t0;
    },
    _parseUri(uri) {
      return uri;
      ...
      var $async$main = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              A.print("NEPSE Web Dashboard Initializing...");
              t1 = new A.BrowserClient(A._setArrayType([], type$.JSArray_JSObject));
              dashboardService = new A.NepseDashboardService(new A.NepseApiClient("http://localhost:3000", t1));
              $async$goto = 2;
              return A._asyncAwait(A.refreshDashboard(dashboardService), $async$main);
            case 2:
              // returning from await.
              A.Timer_Timer$periodic(B.Duration_60000000, new A.main_closure(dashboardService));
              // implicit return
    ...
    refreshDashboard(service) {
      return A.refreshDashboard$body(service);
    },
    refreshDashboard$body(service) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], snapshot, e, exception, $async$exception;
      var $async$refreshDashboard = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 3;
              $async$goto = 6;
              return A._asyncAwait(service._apiClient.getDashboard$1$limit(5), $async$refreshDashboard);
            case 6:
              // returning from await.
              snapshot = $async$result;
              A.updateMarketGrid(snapshot.symbols);
              A.renderPriceChart(snapshot.symbols);
              A.print("Dashboard Refreshed: " + snapshot.generatedAt.toString$0(0));
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
            case 3:
              ...
              $async$exception = $async$errorStack.pop();
              e = A.unwrapException($async$exception);
              A.print("Failed to refresh dashboard: " + A.S(e));
              // goto after finally
              $async$goto = 5;
              break;
            case 2:
      ...
      return A._asyncStartSync($async$refreshDashboard, $async$completer);
    },
    updateMarketGrid(symbols) {
      var t2, t3, t4, t5, t6, lastPrice, t7, change, tr, t8, list,
        t1 = document,
        tbody = t1.querySelector("#gainers-table tbody");
      if (tbody == null)
        return;
      t2 = J.getInterceptor$x(tbody);
      t2.get$children(tbody).clear$0(0);
      for (t3 = A.SubListIterable$(symbols, 0, A.checkNotNullable(10, "count", type$.int), A._arrayInstanceType(symbols)._precomputed1), t4 = t3.$ti, t3 = new A.ListIterator(t3, t3.get$length(0), t4._eval$1("ListIterator<ListIterable.E>")), t4 = t4._eval$1("ListIterable.E"); t3.moveNext$0();) {
        ...
        if (t6.length === 0)
          continue;
        lastPrice = B.JSArray_methods.get$first(t6);
        t6 = lastPrice.close;
        t7 = lastPrice.open;
        change = t6 - t7;
        tr = t1.createElement("tr");
        tr.children.toString;
        t8 = t1.createElement("td");
        t8.toString;
        B.TableCellElement_methods.set$text(t8, t5.symbol);
        tr.appendChild(t8).toString;
        t8 = t1.createElement("td");
        t8.toString;
        B.TableCellElement_methods.set$text(t8, B.JSNumber_methods.toStringAsFixed$1(t6, 2));
        t6 = t8.style;
        t6.fontWeight = "bold";
        tr.appendChild(t8).toString;
        ...
        t6 = change >= 0;
        t8 = t6 ? "+" : "";
        B.TableCellElement_methods.set$text(t5, t8 + B.JSNumber_methods.toStringAsFixed$1(change, 2));
        t8 = t1.createElement("td");
        t8.toString;
        B.TableCellElement_methods.set$text(t8, B.JSNumber_methods.toStringAsFixed$1(change / t7 * 100, 2) + "%");
        if (t6) {
          list = t5.classList;
          list.contains("status-positive").toString;
          list.add("status-positive");
          list = t8.classList;
          list.contains("status-positive").toString;
          list.add("status-positive");
        } else {
          list = t5.classList;
          list.contains("status-negative").toString;
          list.add("status-negative");
          list = t8.classList;
          list.contains("status-negative").toString;
          list.add("status-negative");
        }
        tr.appendChild(t5).toString;
        tr.appendChild(t8).toString;
        t2.get$children(tbody).add$1(0, tr);
      }
    },
    renderPriceChart(symbols) {
      var firstSymbol, t1, t2, t3, dataPoints, categories, options;
      if (symbols.length === 0 || B.JSArray_methods.get$first(symbols).recentPrices.length === 0)
        return;
      firstSymbol = B.JSArray_methods.get$first(symbols);
      t1 = firstSymbol.recentPrices;
      t2 = A._arrayInstanceType(t1);
      t3 = t2._eval$1("MappedListIterable<1,double>");
      dataPoints = A.List_List$_of(new A.MappedListIterable(t1, t2._eval$1("double(1)")._as(new A.renderPriceChart_closure()), t3), t3._eval$1("ListIterable.E"));
      t3 = t2._eval$1("MappedListIterable<1,String>");
      categories = A.List_List$_of(new A.MappedListIterable(t1, t2._eval$1("String(1)")._as(new A.renderPriceChart_closure0()), t3), t3._eval$1("ListIterable.E"));
      t1 = type$.String;
      t2 = type$.bool;
      t3 = type$.Object;
      t3 = A.LinkedHashMap_LinkedHashMap$_literal(["chart", A.LinkedHashMap_LinkedHashMap$_literal(["type", "area", "height", 350, "toolbar", A.LinkedHashMap_LinkedHashMap$_literal(["show", false], t1, t2)], t1, t3), "theme", A.LinkedHashMap_LinkedHashMap$_literal(["mode", "dark"], t1, t1), "colors", A._setArrayType(["#00E5FF"], type$.JSArray_String), "dataLabels", A.LinkedHashMap_LinkedHashMap$_literal(["enabled", false], t1, t2), "stroke", A.LinkedHashMap_LinkedHashMap$_literal(["curve", "smooth", "width", 3], t1, t3), "series", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["name", firstSymbol.symbol, "data", dataPoints], t1, t3)], type$.JSArray_Map_String_Object), "xaxis", A.LinkedHashMap_LinkedHashMap$_literal(["categories", categories], t1, type$.List_String), "fill", A.LinkedHashMap_LinkedHashMap$_literal(["type", "gradient", "gradient", A.LinkedHashMap_LinkedHashMap$_literal(["shadeIntensity", 1, "opacityFrom", 0.7, "opacityTo", 0.1], t1, type$.num)], t1, t3)], t1, t3);
      options = A._wrapToDart(A.JsObject__convertDataTree(t3));
      t1 = $.$get$_context();
      t1.callMethod$2("eval", ["if (window.chart) { window.chart.destroy(); }"]);
      t1.callMethod$2("eval", ["window.chart = new ApexCharts(document.querySelector('#chart'), " + options.toString$0(options) + "); window.chart.render();"]);
    },
    main_closure: function main_closure(t0) {
      this.dashboardService = t0;
    },
    renderPriceChart_closure: function renderPriceChart_closure() {
    },
    renderPriceChart_closure0: function renderPriceChart_closure0() {
    },
    max(a, b, $T) {
  ...
  A.BrowserClient.prototype = {
    ...
    send$body$BrowserClient(_, request) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], $async$self = this, bodyBytes, _0_0, _0_2, _0_2_isSet, abortTrigger, t1, _1_0, contentLength, header, response, contentLengthHeader, contentLength0, headers, e, st, t4, t5, t6, _this, t7, t8, result, exception, t2, abortController, t3, $async$exception;
    ...
    set$body(_, value) {
      ...
      if (contentType == null) {
        ...
        if (t1 != null) {
          ...
          t1 = false;
        if (t1 && !contentType.parameters._collection$_map.containsKey$1(0, "charset")) {
          t1 = _this.get$encoding(0);
          t2 = type$.String;
  ...
  A.AppSettings.prototype = {
    toJson$0() {
      var _this = this;
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", _this.id, "name", _this.name, "autoSaveInterval", _this.autoSaveInterval, "maxDataAgeDays", _this.maxDataAgeDays, "backupEnabled", _this.backupEnabled, "chartStyle", _this.chartStyle, "defaultPeriod", _this.defaultPeriod, "maxWatchlistSize", _this.maxWatchlistSize, "logLevel", _this.logLevel, "refreshInterval", _this.refreshInterval, "createdAt", _this.createdAt.toIso8601String$0(), "updatedAt", _this.updatedAt.toIso8601String$0()], type$.String, type$.dynamic);
    }
  };
  A.DashboardSnapshot.prototype = {
    toJson$0() {
      var t7, _this = this,
        t1 = _this.generatedAt.toIso8601String$0(),
        t2 = _this.settings.toJson$0(),
        t3 = _this.portfolio.toJson$0(),
        t4 = _this.watchlist,
        t5 = A._arrayInstanceType(t4),
        t6 = t5._eval$1("MappedListIterable<1,Map<String,@>>");
      t4 = A.List_List$_of(new A.MappedListIterable(t4, t5._eval$1("Map<String,@>(1)")._as(new A.DashboardSnapshot_toJson_closure()), t6), t6._eval$1("ListIterable.E"));
      t5 = _this.symbols;
      t6 = A._arrayInstanceType(t5);
      t7 = t6._eval$1("MappedListIterable<1,Map<String,@>>");
      t5 = A.List_List$_of(new A.MappedListIterable(t5, t6._eval$1("Map<String,@>(1)")._as(new A.DashboardSnapshot_toJson_closure0()), t7), t7._eval$1("ListIterable.E"));
      return A.LinkedHashMap_LinkedHashMap$_literal(["generatedAt", t1, "settings", t2, "portfolio", t3, "watchlist", t4, "symbols", t5], type$.String, type$.dynamic);
    }
  };
  A.DashboardSnapshot_DashboardSnapshot$fromJson_closure.prototype = {
    call$1(item) {
      var t1 = A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(item), type$.String, type$.dynamic);
      return new A.WatchlistItem(A._asString(t1.$index(0, "id")), A._asString(t1.$index(0, "symbol")), A._asStringQ(t1.$index(0, "notes")), A.DateTime_parse(A._asString(t1.$index(0, "createdAt"))), A.DateTime_parse(A._asString(t1.$index(0, "updatedAt"))));
    },
    $signature: 40
  };
  A.DashboardSnapshot_DashboardSnapshot$fromJson_closure0.prototype = {
    call$1(item) {
      return A.DashboardSymbolSnapshot_DashboardSymbolSnapshot$fromJson(A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(item), type$.String, type$.dynamic));
    },
    $signature: 41
  };
  A.DashboardSnapshot_toJson_closure.prototype = {
    call$1(item) {
      return type$.WatchlistItem._as(item).toJson$0();
    },
    $signature: 42
  };
  A.DashboardSnapshot_toJson_closure0.prototype = {
    call$1(item) {
      return type$.DashboardSymbolSnapshot._as(item).toJson$0();
    },
    $signature: 43
  };
  A.DashboardSymbolSnapshot.prototype = {
    toJson$0() {
      var t2, t3, t4, _this = this,
        t1 = _this.holding;
      t1 = t1 == null ? null : t1.toJson$0();
      t2 = _this.recentPrices;
      t3 = A._arrayInstanceType(t2);
      t4 = t3._eval$1("MappedListIterable<1,Map<String,@>>");
      t2 = A.List_List$_of(new A.MappedListIterable(t2, t3._eval$1("Map<String,@>(1)")._as(new A.DashboardSymbolSnapshot_toJson_closure()), t4), t4._eval$1("ListIterable.E"));
      return A.LinkedHashMap_LinkedHashMap$_literal(["symbol", _this.symbol, "inPortfolio", _this.inPortfolio, "inWatchlist", _this.inWatchlist, "holding", t1, "recentPrices", t2], type$.String, type$.dynamic);
    }
  };
  A.DashboardSymbolSnapshot_DashboardSymbolSnapshot$fromJson_closure.prototype = {
    call$1(item) {
      var t1 = A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(item), type$.String, type$.dynamic);
      return new A.PriceSnapshot(A._asString(t1.$index(0, "id")), A._asString(t1.$index(0, "symbol")), A.DateTime_parse(A._asString(t1.$index(0, "tradeDate"))), A._asNum(t1.$index(0, "open")), A._asNum(t1.$index(0, "high")), A._asNum(t1.$index(0, "low")), A._asNum(t1.$index(0, "close")), A._asNum(t1.$index(0, "volume")), A._asString(t1.$index(0, "source")), A.DateTime_parse(A._asString(t1.$index(0, "createdAt"))), A.DateTime_parse(A._asString(t1.$index(0, "updatedAt"))));
    },
    $signature: 44
  };
  A.DashboardSymbolSnapshot_toJson_closure.prototype = {
    call$1(snapshot) {
      return type$.PriceSnapshot._as(snapshot).toJson$0();
    },
    $signature: 57
  };
  A.PortfolioHolding.prototype = {
    toJson$0() {
      var _this = this,
        t1 = _this.lastUpdated;
      t1 = t1 == null ? null : t1.toIso8601String$0();
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", _this.id, "symbol", _this.symbol, "shares", _this.shares, "buyPrice", _this.buyPrice, "currentPrice", _this.currentPrice, "notes", _this.notes, "lastUpdated", t1, "createdAt", _this.createdAt.toIso8601String$0(), "updatedAt", _this.updatedAt.toIso8601String$0()], type$.String, type$.dynamic);
    }
  };
  A.PortfolioOverview.prototype = {
    toJson$0() {
      var t1 = this.holdings,
        t2 = A._arrayInstanceType(t1),
        t3 = t2._eval$1("MappedListIterable<1,Map<String,@>>");
      t1 = A.List_List$_of(new A.MappedListIterable(t1, t2._eval$1("Map<String,@>(1)")._as(new A.PortfolioOverview_toJson_closure()), t3), t3._eval$1("ListIterable.E"));
      return A.LinkedHashMap_LinkedHashMap$_literal(["holdings", t1, "summary", this.summary.toJson$0()], type$.String, type$.dynamic);
    }
  };
  A.PortfolioOverview_PortfolioOverview$fromJson_closure.prototype = {
    call$1(item) {
      return A.PortfolioHolding_PortfolioHolding$fromJson(A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(item), type$.String, type$.dynamic));
    },
    $signature: 46
  };
  A.PortfolioOverview_toJson_closure.prototype = {
    call$1(holding) {
      return type$.PortfolioHolding._as(holding).toJson$0();
    },
    $signature: 47
  };
  A.PortfolioSummary.prototype = {
    toJson$0() {
      var _this = this;
      return A.LinkedHashMap_LinkedHashMap$_literal(["totalInvestment", _this.totalInvestment, "totalValue", _this.totalValue, "totalGainLoss", _this.totalGainLoss, "totalReturnPct", _this.totalReturnPct, "numStocks", _this.numStocks], type$.String, type$.dynamic);
    }
  };
  A.PriceSnapshot.prototype = {
    toJson$0() {
      var _this = this;
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", _this.id, "symbol", _this.symbol, "tradeDate", _this.tradeDate.toIso8601String$0(), "open", _this.open, "high", _this.high, "low", _this.low, "close", _this.close, "volume", _this.volume, "source", _this.source, "createdAt", _this.createdAt.toIso8601String$0(), "updatedAt", _this.updatedAt.toIso8601String$0()], type$.String, type$.dynamic);
    }
  };
  A.WatchlistItem.prototype = {
    toJson$0() {
      var _this = this;
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", _this.id, "symbol", _this.symbol, "notes", _this.notes, "createdAt", _this.createdAt.toIso8601String$0(), "updatedAt", _this.updatedAt.toIso8601String$0()], type$.String, type$.dynamic);
    }
  };
  A.NepseApiException.prototype = {
    toString$0(_) {
      return "NepseApiException(statusCode: " + this.statusCode + ", message: " + this.message + ", details: " + A.S(this.details) + ")";
    },
    $isException: 1
  };
  A.NepseApiClient.prototype = {
    getDashboard$1$limit(limit) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.DashboardSnapshot),
        $async$returnValue, $async$self = this, t1, $async$temp1, $async$temp2, $async$temp3, $async$temp4;
      var $async$getDashboard$1$limit = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp4 = J;
              $async$goto = 3;
              return A._asyncAwait($async$self._requestJson$3$method$path$queryParameters("GET", "/api/dashboard", A.LinkedHashMap_LinkedHashMap$_literal(["limit", "" + limit], t1, t1)), $async$getDashboard$1$limit);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.DashboardSnapshot_DashboardSnapshot$fromJson($async$temp2.LinkedHashMap_LinkedHashMap$from($async$temp3._as($async$temp4.$index$asx($async$result, "data")), t1, type$.dynamic));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$getDashboard$1$limit, $async$completer);
    },
    _requestJson$3$method$path$queryParameters(method, path, queryParameters) {
      return this._requestJson$body$NepseApiClient(method, path, type$.nullable_Map_String_String._as(queryParameters));
    },
    _requestJson$body$NepseApiClient(method, path, queryParameters) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, $async$self = this, decoded, response, t1, t2, t3;
      var $async$_requestJson$3$method$path$queryParameters = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait($async$self._send$4$body$method$path$queryParameters(null, method, path, queryParameters), $async$_requestJson$3$method$path$queryParameters);
            case 3:
              // returning from await.
              response = $async$result;
              t1 = response.headers;
              t2 = A.encodingForContentTypeHeader(A._contentTypeForHeaders(t1));
              t3 = response.bodyBytes;
              if (t2.decode$1(0, t3).length === 0) {
                $async$returnValue = B.Map_empty0;
                // goto return
                $async$goto = 1;
                break;
              }
              decoded = B.C_JsonCodec.decode$2$reviver(0, A.encodingForContentTypeHeader(A._contentTypeForHeaders(t1)).decode$1(0, t3), null);
              ...
              if (type$.Map_dynamic_dynamic._is(decoded)) {
                $async$returnValue = A.LinkedHashMap_LinkedHashMap$from(decoded, type$.String, type$.dynamic);
                // goto return
                $async$goto = 1;
                break;
              }
              throw A.wrapException(A.NepseApiException$(decoded, "Expected a JSON object response", response.statusCode));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
      });
      return A._asyncStartSync($async$_requestJson$3$method$path$queryParameters, $async$completer);
    },
    _send$4$body$method$path$queryParameters(body, method, path, queryParameters) {
      return this._send$body$NepseApiClient(body, method, path, type$.nullable_Map_String_String._as(queryParameters));
    },
    _send$body$NepseApiClient(body, method, path, queryParameters) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Response),
        $async$returnValue, $async$self = this, normalizedBaseUrl, uri, t2, t1;
      var $async$_send$4$body$method$path$queryParameters = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1._as(queryParameters);
              normalizedBaseUrl = $async$self.baseUrl;
              uri = A.Uri_parse((B.JSString_methods.endsWith$1(normalizedBaseUrl, "/") ? B.JSString_methods.substring$2(normalizedBaseUrl, 0, normalizedBaseUrl.length - 1) : normalizedBaseUrl) + path).replace$1$queryParameters(0, queryParameters);
            case 3:
              // switch
              switch (method) {
                case "GET":
            ...
            case 5:
              // case
              $async$goto = 10;
              return A._asyncAwait($async$self._httpClient._sendUnstreamed$3("GET", uri, t1._as(B.Map_E7o4Y)), $async$_send$4$body$method$path$queryParameters);
            case 10:
              // returning from await.
              $async$returnValue = $async$self._handleResponse$1($async$result);
              // goto return
              $async$goto = 1;
              break;
            case 6:
              // case
              t2 = B.C_JsonCodec.encode$2$toEncodable(B.Map_empty0, null);
              $async$goto = 11;
              return A._asyncAwait($async$self._httpClient._sendUnstreamed$5("POST", uri, t1._as(B.Map_E7o4Y), t2, null), $async$_send$4$body$method$path$queryParameters);
            case 11:
              // returning from await.
              $async$returnValue = $async$self._handleResponse$1($async$result);
              // goto return
            ...
            case 7:
              ...
              t2 = B.C_JsonCodec.encode$2$toEncodable(B.Map_empty0, null);
              $async$goto = 12;
              return A._asyncAwait($async$self._httpClient._sendUnstreamed$5("PATCH", uri, t1._as(B.Map_E7o4Y), t2, null), $async$_send$4$body$method$path$queryParameters);
            case 12:
              // returning from await.
              $async$returnValue = $async$self._handleResponse$1($async$result);
              // goto return
            ...
            case 8:
              // case
              $async$goto = 13;
              return A._asyncAwait($async$self._httpClient._sendUnstreamed$5("DELETE", uri, t1._as(B.Map_E7o4Y), null, null), $async$_send$4$body$method$path$queryParameters);
            case 13:
              // returning from await.
              $async$returnValue = $async$self._handleResponse$1($async$result);
              // goto return
            ...
            case 9:
              // default
              throw A.wrapException(A.ArgumentError$value(method, "method", "Unsupported HTTP method"));
            case 4:
              // after switch
            case 1:
              // return
      ...
      return A._asyncStartSync($async$_send$4$body$method$path$queryParameters, $async$completer);
    },
    _handleResponse$1(response) {
      var t2, t3, message, decoded, details, mapped,
        _s14_ = "Request failed",
        t1 = response.statusCode;
      if (t1 >= 200 && t1 < 300)
        return response;
      t2 = response.headers;
      t3 = response.bodyBytes;
      message = _s14_;
      if (A.encodingForContentTypeHeader(A._contentTypeForHeaders(t2)).decode$1(0, t3).length !== 0) {
        decoded = B.C_JsonCodec.decode$2$reviver(0, A.encodingForContentTypeHeader(A._contentTypeForHeaders(t2)).decode$1(0, t3), null);
        if (type$.Map_String_dynamic._is(decoded)) {
          message = A._asStringQ(J.$index$asx(decoded, "error"));
          if (message == null)
            message = _s14_;
          details = decoded;
        } else if (type$.Map_dynamic_dynamic._is(decoded)) {
          mapped = A.LinkedHashMap_LinkedHashMap$from(decoded, type$.String, type$.dynamic);
          message = A._asStringQ(mapped.$index(0, "error"));
          if (message == null)
            message = _s14_;
          details = mapped;
        } else
        ...
        details = null;
      throw A.wrapException(A.NepseApiException$(details, message, t1));
    }
  };
  A.NepseDashboardService.prototype = {};
  A.Context.prototype = {
    absolute$1(_, part1) {
      var t2, parts,
  ...
  A.main_closure.prototype = {
    call$1(__wc0_formal) {
      ...
      return A.refreshDashboard(this.dashboardService);
    },
    $signature: 59
  };
  A.renderPriceChart_closure.prototype = {
    call$1(p) {
      return type$.PriceSnapshot._as(p).close;
    },
    $signature: 60
  };
  A.renderPriceChart_closure0.prototype = {
    call$1(p) {
      var t1 = type$.PriceSnapshot._as(p).tradeDate.toString$0(0).split(" ");
      if (0 >= t1.length)
        return A.ioore(t1, 0);
      return t1[0];
    },
  ...
  (function installTearOffs() {
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 23, 0, 0);
    ...
    _static_1(A, "js___convertToJS$closure", "_convertToJS", 16);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 67);
    _static_1(A, "case_insensitive_map_CaseInsensitiveMap__canonicalizer$closure", "CaseInsensitiveMap__canonicalizer", 7);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.ListBase, A.Closure, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.ExpandIterator, A.TakeIterator, A.SkipIterator, A.EmptyIterator, A.WhereTypeIterator, A.FixedLengthListMixin, A.UnmodifiableListMixin, A.Symbol, A.MapView, A.ConstantMap, A._KeysOrValuesOrElementsIterator, A.JSInvocationMirror, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A._Required, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapValueIterator, A.LinkedHashMapEntryIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._AllMatchesIterator, A.StringMatch, A._StringAllMatchesIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamController, A._AsyncStreamControllerDispatch, A._BufferingStreamSubscription, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._DoneStreamSubscription, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A._UnmodifiableMapMixin, A.Codec, A.Converter, A.ByteConversionSink, A._JsonStringifier, A._Utf8Encoder, A._Utf8Decoder, A.DateTime, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A._Uri, A.UriData, A._SimpleUri, A.CssStyleDeclarationBase, A.ImmutableListMixin, A.FixedSizeListIterator, A.JsObject, A.NullRejectionException, A.CanonicalizedMap, A.ClientException, A.BaseClient, A.BaseRequest, A.BaseResponse, A.MediaType, A.AppSettings, A.DashboardSnapshot, A.DashboardSymbolSnapshot, A.PortfolioHolding, A.PortfolioOverview, A.PortfolioSummary, A.PriceSnapshot, A.WatchlistItem, A.NepseApiException, A.NepseApiClient, A.NepseDashboardService, A.Context, A.Style, A.ParsedPath, A.PathException, A.SourceFile, A.SourceLocationMixin, A.SourceSpanMixin, A.Highlighter, A._Highlight, A._Line, A.SourceLocation, A.SourceSpanException, A.StringScanner]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Instantiation, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._LinkedCustomHashMap_closure, A.DateTime_parse_parseIntOrZero, A.DateTime_parse_parseMilliAndMicroseconds, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.FilteredElementList_removeRange_closure, A.JsObject__convertDataTree__convert, A._convertToJS_closure, A._convertToJS_closure0, A._wrapToDart_closure, A._wrapToDart_closure0, A._wrapToDart_closure1, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.CanonicalizedMap_keys_closure, A.BaseRequest_closure0, A.BrowserClient_send_closure, A._bodyToStream_closure, A.ByteStream_toBytes_closure, A.MediaType_toString__closure, A.expectQuotedString_closure, A.DashboardSnapshot_DashboardSnapshot$fromJson_closure, A.DashboardSnapshot_DashboardSnapshot$fromJson_closure0, A.DashboardSnapshot_toJson_closure, A.DashboardSnapshot_toJson_closure0, A.DashboardSymbolSnapshot_DashboardSymbolSnapshot$fromJson_closure, A.DashboardSymbolSnapshot_toJson_closure, A.PortfolioOverview_PortfolioOverview$fromJson_closure, A.PortfolioOverview_toJson_closure, A.Context_joinAll_closure, A.Context_split_closure, A._validateArgList_closure, A.Highlighter$__closure, A.Highlighter$___closure, A.Highlighter$__closure0, A.Highlighter__collateLines_closure, A.Highlighter__collateLines_closure1, A.Highlighter__collateLines__closure, A.Highlighter_highlight_closure, A.main_closure, A.renderPriceChart_closure, A.renderPriceChart_closure0]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.FormElement, A.SelectElement, A.TableCellElement]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      DashboardSnapshot: findType("DashboardSnapshot"),
      DashboardSymbolSnapshot: findType("DashboardSymbolSnapshot"),
      ...
      PortfolioHolding: findType("PortfolioHolding"),
      PriceSnapshot: findType("PriceSnapshot"),
      ...
      Uri: findType("Uri"),
      WatchlistItem: findType("WatchlistItem"),
...
;
    ...
    B.Object_YsE = {Accept: 0, "Content-Type": 1};
    B.Map_E7o4Y = new A.ConstantStringMap(B.Object_YsE, ["application/json", "application/json"], type$.ConstantStringMap_String_String);
